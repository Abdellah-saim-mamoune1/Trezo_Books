...
{
    public class BookCopyRepository(AppDbContext _db): IBookCopyRepository
    {


        public async Task<int> Create(BookCopyDto BookCopy)
        {
            int Id = -1;
            try
            {
        ...
        public async Task<GetPaginatedBooksCopiesDto> GetPaginatedBooksCopiesAsync(PaginationFormDto form)
        {
            ...
            return new GetPaginatedBooksCopiesDto
            {
