...
{
    public class EBookRepository(AppDbContext _db): IEBookRepository
    {
        ...
        public async Task<bool> Update(DEBookGetXUpdate form)
        {
            bool success = false;
            try
            {
        ...
        public async Task<DEGetPaginatedBooks> GetPaginatedBooksAsync(DPaginationForm form)
        {
            var allAuthorsQueryable = _db.Books.AsQueryable();

            var Books = await allAuthorsQueryable
                .Select(a => new DEBookGetXUpdate
                {
                    Id = a.Id,
                    AuthorId = a.AuthorId,
                    Name = a.Name,
            ...
            return new DEGetPaginatedBooks
            {
        ...
        public async Task<DEBookGetXUpdate?> GetBookByIdAsync(int Id)
        {
        ...
        public async Task<List<DEBookGetXUpdate>?> GetBookByNameAsync(string Name)
        {
