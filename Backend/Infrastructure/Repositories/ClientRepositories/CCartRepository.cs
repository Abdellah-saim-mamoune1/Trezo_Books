...
{
    public class CCartRepository(AppDbContext _db): ICCartRepository
    {
        ...
        public async Task<bool> UpdateAsync(DCUpdateCartItem Item, int clientId)
        {
            bool Success = false;
            try
            {
        ...
        public async Task<List<DCGetCartItem>> GetClientCartItemsAsync(int Id)
        {
