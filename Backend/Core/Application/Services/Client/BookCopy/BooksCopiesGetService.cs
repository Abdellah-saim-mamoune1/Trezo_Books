...
{
    public class BooksCopiesGetService
        (
        IBookCopyRepository _Repo,
        AppDbContext _db
      
        ): IBooksCopiesGetService
    {
        public async Task<ApiResponseDto<object?>> GetInitialBooksCopiesDataPerType()
        {
        ...
        public async Task<ApiResponseDto<object?>> GetInitialRecommendedBooksCopiesData()
        {
        ...
        public async Task<ApiResponseDto<object?>> GetInitialTopRatedBooksCopiesData()
        {
        ...
        public async Task<ApiResponseDto<object?>> GetInitialBestSellersBooksCopiesData()
        {
        ...
        public async Task<ApiResponseDto<object?>> GetInitialNewReleasedBooksCopiesData()
        {
        ...
        public async Task<ApiResponseDto<object?>> GetBooksTypes()
        {
        ...
        public async Task<ApiResponseDto<object?>> GetInitialBooksCopiesDataByType(GetPaginatedBooksTypesDto form)
        {
            ...
            {
                errors.Add(new ValidationErorrsDto { FieldId = "Type", Message = "Book type not found." });
            }
        ...
        public async Task<ApiResponseDto<object?>> GetBookCopyInfoById(int Id)
        {
            List<ValidationErorrsDto> errors = new();
        ...
        public async Task<ApiResponseDto<object?>> GetBooksCopiesInfoByName(string Name)
        {
            List<ValidationErorrsDto> errors = new();
