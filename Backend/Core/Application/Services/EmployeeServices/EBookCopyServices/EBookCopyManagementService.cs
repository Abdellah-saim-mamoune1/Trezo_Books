...
{
    public class EBookCopyManagementService
        (
    
        IEBookCopyRepository _Repo,
        IEBookCopyManagementValidationService _Validate

        ) : IEBookCopyManagementService
    {


        public async Task<DApiResponse<object?>> CreateBookCopyAsync(DEBookCopy bookCopy)
        {
        ...
        public async Task<DApiResponse<object?>> UpdateBookCopyAsync(DBookCopyGetXUpdate bookCopy)
        {
        ...
        public async Task<DApiResponse<object?>> DeleteBookCopyAsync(int BookCopyId)
        {
        ...
        public async Task<DApiResponse<object?>> GetPaginatedBooksCopiesAsync(DPaginationForm Form)
        {
        ...
        public async Task<DApiResponse<object?>> GetBookCopyByIdAsync(int Id)
        {
