...
{
    public class EOrdersManagementService
        (
        IEOrdersManagementValidationService _Validate,
        IEGetPaginatedOrders _Get
        ): IEOrdersManagementService
    {



        public async Task<DApiResponse<object?>> GetPaginatedOrderAsync(DPaginationForm form)
        {
        ...
        public async Task<DApiResponse<object?>> SetOrderStatusAsync(int OrderId,string status)
        {
