...
{
    public class EmployeeManagementValidatorsService(AppDbContext _db)
    {
        public async Task<List<ValidationErorrsDto>?> ValidateRegister(EmployeeSignUpDto signUp)
        {
        ...
        public async Task<List<ValidationErorrsDto>?> ValidateUpdate(PersonDto form)
        {
        ...
        public async Task<List<ValidationErorrsDto>?> ValidateResetPassword(ResetPasswordDto form, int Id)
        {
